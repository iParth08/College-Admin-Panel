    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Register alumni to provide them with access to the platform without
            going through the regular verification process.
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            {isSuccess && (
              <Alert className="bg-green-50 text-green-800 dark:bg-green-900 dark:text-green-50">
                ...
                <AlertDescription>
                  Alumni registration has been successfully submitted.
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="flex items-start gap-2 rounded-md bg-muted p-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  This form bypasses the regular user verification process.
                  Alumni will receive an email with login credentials and can
